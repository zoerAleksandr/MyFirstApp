...
import com.example.myfirstapp.data.TrainData
    ...
    companion object {
        fun createNewEntityItinerary(itinerary: Itinerary) =
            EntityItinerary(
                ...
                followingByPassengerList = EntityFollowingByPassenger.toEntityFollowingByPassengerList(itinerary.followingByPassengerList),
